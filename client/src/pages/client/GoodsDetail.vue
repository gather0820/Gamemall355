<template>
  <div class="GoodsDetail container-wrapper-public">
    <div class="content">
      <div class="goodsInfo">
      ...
      <section class="msgBox leftContainer">
        ...
        <div class="commentBody" v-if="curIndex === 0">
          ...
          <div class="noComment" v-else>There were no immediate comments~</div>
        </div>
